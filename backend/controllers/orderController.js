...
export const placeOrder = async (req, res) => {
  try {
    const { userId, address } = req.body; // Get the userId and address from the request
...
export const updateOrderStatus = async (req, res) => {
  try {
    const { orderId, status } = req.body; // Get the orderId and new status from the request body
